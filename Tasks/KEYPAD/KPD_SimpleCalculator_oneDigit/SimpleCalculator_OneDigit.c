...
// can perform arithmetic operation on numbers that only one digit.
void APP_voidSimpleCalculatorOneDigit(u8 Local_u8ButtonPressed)
{

	static u8 Local_Number1Pressed = 0xff;
	static u8 Local_Number2Pressed = 0xff;
	static u8 Local_OperationPressed = 0xff;
	static s16 Local_Result = 0xffff;
	...
	if (Local_u8ButtonPressed == 'c')
	{
		...
		Local_Number1Pressed = 0xff;
		Local_Number2Pressed = 0xff;
	...
	else
	{
		...
		if (Local_u8ButtonPressed <= 9 && Local_Number1Pressed == 0xff)
		{
			Local_Number1Pressed = Local_u8ButtonPressed;
			HLCD_voidSendNumber(Local_u8ButtonPressed);
		}
		else if ((Local_u8ButtonPressed == '+' || Local_u8ButtonPressed == '/' || Local_u8ButtonPressed == '-' || Local_u8ButtonPressed == '*') && Local_OperationPressed == 0xff && Local_Number1Pressed != 0xff)
		{
			Local_OperationPressed = Local_u8ButtonPressed;
			HLCD_voidSendData(Local_u8ButtonPressed);
		}

		else if (Local_u8ButtonPressed <= 9 && Local_Number2Pressed == 0xff && Local_OperationPressed != 0xff)
		{
			Local_Number2Pressed = Local_u8ButtonPressed;
			HLCD_voidSendNumber(Local_u8ButtonPressed);
		}
		else if (Local_u8ButtonPressed == '=' && Local_Number1Pressed != 0xff && Local_Number2Pressed != 0xff && Local_OperationPressed != 0xff)
		{
			HLCD_voidSendData('=');
...
int main(void)
{
	...
	while (1)
	{
		...
		{
			APP_voidSimpleCalculatorOneDigit(Local_u8ButtonPressed);
		}
	}
